  ...
  WHERE u.dni = ?")) {
        ...
        if ($resultado->num_rows == 1) {
            ...
            if (password_verify($pas, $encriptado_db))
            {
                ...
                echo json_encode(array('conectado'=>true,'idUsuario'=>$datos['idUsuario'], 'nombre'=>$datos['nombre'], 'dni'=>$datos['dni'], 'clave'=>$datos['clave'], 'email'=>$datos['email'],'nombreRol'=>$datos['nombreRol']  ) );
              }
